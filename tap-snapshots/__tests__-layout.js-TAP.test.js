 ...
 */
'use strict'
exports[`__tests__/layout.js TAP Layout() - rendering using a string - with assets > must match snapshot 1`] = `
<!doctype html>
<html lang="en-US">
    <head>
        <meta charset="utf-8">
...
exports[`__tests__/layout.js TAP Layout() - setting a custom view template > must match snapshot 1`] = `
